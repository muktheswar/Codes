...
VI b1(26);
cin>>a>>b;
int m1=0,m2=0,po=0,po1;
FOR(i,0,sz(a)){a1[a[i]-97]++;b1[b[i]-97]++;if(a[i]-97>m1){m1=a[i]-97;po=i;}if(b[i]-97>m2){m2=b[i]-97;po1=i;}}
//for(int i=po-1;i>=0;i--)a1[a[i]-97]--;
VI a2(sz(a));
for(int i=0;i<sz(a);i++){
if(a1[m1]==0){m1=0;FOR(j,i,sz(a)){if(a[j]-97>m1){m1=a[j]-97;po=j;}}}
if(b1[m2]==0){m2=0;FOR(j,i,sz(a)){if(b[j]-97>m2){m2=b[j]-97;po1=j;}}}
if(97-a[i]==m1 && 97-b[i]==m2){a2[i]=1;a1[m1]--;b1[m2]--;}
}
for(int i=0;i<sz(a);i++)if(a2[i]==1)cout<<a[i];
for(int i=0;i<sz(a);i++)if(a2[i]==1)cout<<b[i];
cout<<"\n";
	return 0;
}
