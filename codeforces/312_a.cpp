...
getline(cin,s);
//cout<<s<<"\n";
if(sz(s)<5){printf("OMG>.< I don't know!\n");continue;}
string t;
FOR(i,0,5){
t+=s[i];
}
string t1;
for(int i=sz(s)-5;i<sz(s);i++)t1+=s[i];
if(t1=="lala." && t=="miao."){printf("OMG>.< I don't know!\n");continue;}
if(t1=="lala."){printf("Freda's\n");continue;}
if(t=="miao."){printf("Rainbow's\n");continue;}
