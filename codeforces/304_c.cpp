...
FOR(i,0,n)printf("%d ",b[i]);printf("\n");
FOR(i,0,n)printf("%d ",(a[i]+b[i])%n);printf("\n");
*/
FOR(i,0,n)printf("%d ",i);printf("\n");
FOR(i,0,n)printf("%d ",(i+1)%n);printf("\n");
FOR(i,0,n)printf("%d ",(2*i+1)%n);printf("\n");
	return 0;
}
