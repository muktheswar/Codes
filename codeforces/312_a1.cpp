...
string s=string(ch);
//cout<<s<<"\n";
if(sz(s)<5){cout<<"OMG>.< I don't know!\n";continue;}
string t1=s.substr(0,5);
string t2=s.substr(sz(s)-5,5);
if(t1=="miao." && t2=="lala."){cout<<"OMG>.< I don't know!\n";continue;}
if(t1=="miao."){cout<<"Rainbow's\n";continue;}
if(t2=="lala."){cout<<"Freda's\n";continue;}
