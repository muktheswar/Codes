...
int main(){
while(1){
int a=SI,b=SI,ans=INF,flagans=0;;
int in1=a,in2=b;
if(a==0 && b==0)break;
if(a==b){printf("%d %d 2\n",a,b);continue;}
vector<int> p1(812),p2(812);
vector<int> flag1(812),flag2(812);
if(a<812){p1[a]=1;flag1[a]=1;}
if(b<812){p2[b]=1;flag2[b]=1;}
int count1=1,count2=1;
int loop1=0,loop2=0;
while(1){
int sum1=0,sum2=0;
while(a!=0){int x=a%10;a/=10;sum1+=(x*x);}
while(b!=0){int x=b%10;b/=10;sum2+=(x*x);}
if(loop1==0 && flag1[sum1]==0)count1++;
else loop1=1;
if(loop2==0 && flag2[sum2]==0)count2++;
else loop2=1;
if(loop1==0 && flag1[sum1]==0){p1[sum1]=count1;flag1[sum1]=1;}
if(loop2==0 && flag2[sum2]==0){p2[sum2]=count2;flag2[sum2]=1;}
if(loop1==1 && loop2==1){break;}
int ans1=INF,ans2=INF;
int f=0;
if(flag2[sum1]){f=1;ans1=p1[sum1]+p2[sum1];}
if(flag1[sum2]){f=1;ans2=p2[sum2]+p1[sum2];}
if(f==1){int t=min(ans1,ans2);if(t<ans){ans=t;flagans=1;}}
a=sum1;
b=sum2;
}
if(flagans)printf("%d %d %d\n",in1,in2,ans);
else printf("%d %d 0\n",in1,in2);
}
	return 0;
}
