...
do{
if((a[alli[0]].r==a[alli[1]].l)&&
(a[alli[0]].b==a[alli[3]].t)&&
(a[alli[1]].r==a[alli[2]].l)&&
(a[alli[1]].b==a[alli[4]].t)&&
(a[alli[2]].b==a[alli[5]].t)&&
(a[alli[3]].r==a[alli[4]].l)&&
(a[alli[3]].b==a[alli[6]].t)&&
(a[alli[4]].r==a[alli[5]].l)&&
(a[alli[4]].b==a[alli[7]].t)&&
(a[alli[6]].r==a[alli[7]].l)&&
(a[alli[7]].r==a[alli[8]].l)&&
(a[alli[5]].b==a[alli[8]].t))break;
}while(next_permutation(all(alli)));
FOR(i,0,n)printf("%d",alli[i]+1);
printf("\n");
}
