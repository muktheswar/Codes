...
int sum=0;
pch=strtok(a," +=");
if(pch!=NULL)strcpy(pch1,pch);
pch=strtok(NULL," +=");
if(pch!=NULL)strcpy(pch2,pch);
pch=strtok(NULL," +=");
if(pch!=NULL)strcpy(pch3,pch);
int f=0;
int a1,b1,c1;
int t=0;
for(int i=0;pch1[i]!=0;i++)if(pch1[i]=='m'){f=1;break;}
if(f==0)a1=atoi(pch1);
else t=0;
f=0;
for(int i=0;pch2[i]!=0;i++)if(pch2[i]=='m'){f=1;break;}
if(f==0)b1=atoi(pch2);
else t=1;
f=0;
for(int i=0;pch3[i]!=0;i++)if(pch3[i]=='m'){f=1;break;}
if(f==0)c1=atoi(pch3);
else t=2;
if(t==0)a1=c1-b1;
if(t==1)b1=c1-a1;
...
printf("%s\n",pch);
int f=0;
for(int i=0;pch[i]!=0;i++)if(pch[i]=='m'){f=1;break;}
if(f==0)sum+=atoi(pch);
pch=strtok(NULL," +=");
}*/
getchar();
