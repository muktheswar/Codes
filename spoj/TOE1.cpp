...
if(x==3){win_x++;d_x++;}
if(o==3){win_o++;d_o++;}
if(d_x==1 && no_x==no_o+1){printf("yes\n");continue;}
d_x=0;
d_o=0;
x=0;
o=0;
...
if(o==3){win_o++;d_o++;}
if(d_x==1 && no_x==no_o+1){printf("yes\n");continue;}
if(no_x==0 && no_o==0){printf("yes\n");continue;}
else{
if(win_x==0 && win_o==0){
if(no_x==no_o+1 || no_x==no_o)printf("yes\n");
else printf("no\n");
continue;
}
else{
if(win_x>0 && win_o>0){printf("no\n");continue;}
else{
if(win_x>0){
if(win_x>2){printf("no\n");}
else{
if(no_x==no_o+1)printf("yes\n");
else printf("no\n");
}
}
else{
if(win_o>1){printf("no\n");}
else{
if(no_x==no_o)printf("yes\n");
else printf("no\n");
}
}
}
