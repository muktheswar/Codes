...
FOR(i,0,n)go[i]=SI;
sort(all(go));
FOR(i,0,n)back[i]=1422-go[n-i-1];
//FOR(i,0,n)cout<<go[i]<<" ";cout<<"\n";
//FOR(i,0,n)cout<<back[i]<<" ";cout<<"\n";
if(1422-go[n-1]>200){printf("IMPOSSIBLE\n");continue;}
int i=1;
while(i<n && go[i]-go[i-1]<=200){i++;}
if(i<n){printf("IMPOSSIBLE\n");continue;}
i=1;
if((1422-go[n-1])*2>200){printf("IMPOSSIBLE\n");continue;}
if(1422-back[n-1]>200){printf("IMPOSSIBLE\n");continue;}
while(i<n && back[i]-back[i-1]<=200){i++;}
if(i<n){printf("IMPOSSIBLE\n");continue;}
printf("POSSIBLE\n");
}
